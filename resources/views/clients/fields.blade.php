<div class="row gx-10 mb-5">
    <div class="col-lg-6">
        <div class="mb-5">
            {{ Form::label('first_name', __(key: 'messages.client.first_name') . ':', ['class' => 'form-label required mb-3']) }}
    ...
    <div class="col-lg-6">
        <div class="mb-5">
            {{ Form::label('email', __('messages.client.email') . ':', ['class' => 'form-label required mb-3']) }}
            {{ Form::email('email', \App\Models\Client::generateUniqueEmail(), ['class' => 'form-control', 'placeholder' => __('messages.client.email'), 'required', 'id' => 'email-field']) }}
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Get the generated email value from the backend
            const generatedEmail = emailField.value;
    
            // Event listener for clearing the email field on click
            emailField.addEventListener('focus', function() {
                if (this.value === generatedEmail) {
                    this.value = '';  // Clear the field if it's the generated email
                }
            });
        });
    </script>
