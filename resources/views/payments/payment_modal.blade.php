            ...
            <div class="modal-body scroll-y">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-lg-4 col-sm-12 mb-5 ">
                        ...
                        <div class="input-group">
                            {{ Form::number('amount', null, ['id' => 'amount', 'class' => 'form-control  amount d-flex', 'step' => 'any', 'oninput' => "validity.valid||(value=value.replace(/[e\+\-]/gi,''))", 'min' => '1', 'pattern' => "^\d*(\.\d{0,2})?$", 'required', 'placeholder' => __('messages.invoice.amount')]) }}
                            <a class="input-group-text bg-secondary border-0 text-decoration-none invoice-currency-code"
                                id="autoCode" href="javascript:void(0)" data-toggle="tooltip" data-placement="right"
                                title="Currency Code">
                                {{ getCurrencySymbol() }}
