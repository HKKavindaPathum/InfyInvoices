            ...
            <div class="modal-body scroll-y">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-lg-4 col-sm-12 mb-5 amount d-block">
                        ...
                        <div class="input-group">
                            {{ Form::number('amount', null, ['id' => 'edit_amount', 'class' => 'form-control ', 'step' => 'any', 'oninput' => "validity.valid||(value=value.replace(/[e\+\-]/gi,''))", 'min' => '1', 'required', 'placeholder' => __('messages.invoice.amount')]) }}
                            <a class="input-group-text bg-secondary border-0 text-decoration-none edit-invoice-currency-code"
                                id="autoCode" href="javascript:void(0)" data-toggle="tooltip" data-placement="right"
                                title="Currency Code">
                                {{ getCurrencySymbol() }}
